...
packages="ncat tree axel entr ack ack-grep silversearcher-ag epel-release.noarch the_silver_searcher nload htop pigz mosh mobile-shell git tmux zsh vim mlocate p7zip p7zip-plugins nc psmisc sysstat bind-utils net-tools unrar unrar-free fd fzf"
